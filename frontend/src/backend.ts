...
export class Backend implements backendInterface {
    ...
    async addUpdate(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addUpdate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentUpdates(): Promise<Array<[string, Time]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentUpdates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopPosts(): Promise<Array<[string, string, bigint]>> {
        if (this.processError) {
            try {
